...
func TestProcess(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(tc.desc, func(t *testing.T) {
			//t.Parallel()
			gotResp, err := Process(tc.have, tc.haveinput)
